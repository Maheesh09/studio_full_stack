...
public class Order {
    ...
    public PaymentStatus getAdvancePaymentStatus() {
        return advancePaymentStatus;
    }

    public void setAdvancePaymentStatus(PaymentStatus advancePaymentStatus) {
    ...
    public PaymentStatus getBalancePaymentStatus() {
        return balancePaymentStatus;
    }

    public void setBalancePaymentStatus(PaymentStatus balancePaymentStatus) {
